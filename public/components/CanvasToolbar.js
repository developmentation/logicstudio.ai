  ...
  `,
    setup(props, { emit }) {
      ...
      const addTools = [
        ...
        { id: 'transcribe', label: 'Audio to Text', icon: 'pi pi-microphone', type: 'transcribe' },
        { id: 'web', label: 'Web Content', icon: 'pi pi-globe', type: 'tool' },
        { id: 'join', label: 'Logic / Join', icon: 'pi pi-plus', type: 'tool' },
        { id: 'trigger', label: 'Trigger', icon: 'pi pi-arrow-circle-right', type: 'trigger' },
        { id: 'display', label: 'Display', icon: 'pi pi-image', type: 'display' },
